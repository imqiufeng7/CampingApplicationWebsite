-- Enforces capacity_total at the RPC layer too — the public page's own capacity check
-- (app/(public)/s/[sessionId]/page.tsx) is only a UX nicety and has a race window
-- between two people submitting near the last remaining slot; this is the actual
-- guarantee.
